...
const mockLevels = [
  { level: 1, icon: 'C', title: 'CER Claim', content: 'Device efficacy claim', moduleType: 'CER', auditTrail: ['Created 2024-01-01'], navigateTo: '/cer/s3' },
  { level: 2, icon: 'S', title: 'SOA Finding', content: 'Literature supports claim', moduleType: 'SOA', auditTrail: ['Extracted 2024-01-02'], navigateTo: '/soa/f1' },
  { level: 3, icon: 'L', title: 'SLS Article', content: 'PubMed article ref', moduleType: 'SLS', auditTrail: ['Screened 2024-01-03', 'Approved 2024-01-04'], navigateTo: '/sls/a1' },
  { level: 4, icon: 'V', title: 'Validation Result', content: 'Endpoint met', moduleType: 'VAL', auditTrail: [], navigateTo: '/val/r1' },
];
...
describe('TraceabilityDrillDown', () => {
  ...
  it('calls onExportProof when button clicked', () => {
    ...
    render(<TraceabilityDrillDown claimText="Device is safe" levels={mockLevels} onExportProof={onExport} />);
