...
const mockFindings = [
  ...
  },
  {
    id: 'f-2',
    sourceDatabase: 'ANSM',
    reportNumber: 'ANSM-2024-002',
    eventDate: '2024-02-10',
    deviceName: 'CardioDevice X',
    eventType: 'Injury',
    description: 'Patient reported discomfort',
    outcome: 'Minor injury',
    linkedSection: '3',
  },
  {
    id: 'f-3',
    sourceDatabase: 'BfArM',
    reportNumber: 'BfArM-2024-003',
    eventDate: '2024-03-05',
    deviceName: 'CardioDevice Y',
    eventType: 'Death',
    description: 'Fatal event reported',
    outcome: 'Death',
    linkedSection: null,
  },
];
