...
describe('UpstreamModuleSelector', () => {
  ...
  it('renders the selector container', () => {
    render(<UpstreamModuleSelector projectId="p-1" selectedIds={[]} onSelectionChange={mockOnChange} />);
  ...
  it('deselects when already selected', () => {
    render(<UpstreamModuleSelector projectId="p-1" selectedIds={['sls-1']} onSelectionChange={mockOnChange} />);
    const checkboxes = screen.getAllByTestId('link-checkbox');
    fireEvent.click(checkboxes[0]);
